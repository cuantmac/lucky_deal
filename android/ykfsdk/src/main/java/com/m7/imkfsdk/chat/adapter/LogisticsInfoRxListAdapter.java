...
public class LogisticsInfoRxListAdapter extends RecyclerView.Adapter {
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        ...
        if (viewType == 1) {
            ...
            GlideUtil.loadImage(context,orderInfoBean.getImg(),2f,shopHolder.iv_shop_group_img);
            ...
            GlideUtil.loadImage(context,orderInfoBean.getImg(),2f,childHolder.iv_child_img);
            //item点击事件
