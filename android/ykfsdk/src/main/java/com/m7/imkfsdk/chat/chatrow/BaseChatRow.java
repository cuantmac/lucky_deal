            ...
            if ("1".equals(detail.userType)) {
                ...
                if (detail.showHtml != null && detail.showHtml) {//机器人头像
                    ...
                    if (!"".equals(xiaomoRobotAvator1)) {
                        GlideUtil.loadHeader(context,xiaomoRobotAvator1 + "?imageView2/0/w/200/h/200/q/90",R.drawable.kf_head_default_robot,R.drawable.kf_head_default_robot,baseHolder.getChattingAvatar());
                    } else {
                    ...
                    GlideUtil.loadHeader(context,imgPath + "?imageView2/0/w/100/h/100",R.drawable.kf_head_default_local,R.drawable.kf_head_default_local,baseHolder.getChattingAvatar());
                    ...
                    if (!TextUtils.isEmpty(systemMsgLogo)) {
                        GlideUtil.loadHeader(context,systemMsgLogo + "?imageView2/0/w/100/h/100",R.drawable.kf_head_default_local,R.drawable.kf_head_default_local,baseHolder.getChattingAvatar());
                    } else {
                        /*
                         * else : 显示默认头像
                         */
                 ...
                 */
                baseHolder.getChattingAvatar().setImageResource(R.drawable.kf_head_default_right);
            }
        }
    }
}
