...
public class ChatAdapter extends BaseAdapter {
    ...
    void initRowItems() {
        ...
        chatRowHashMap.put(23, new InvestigateCancelRxChatRow(23));//取消评价类型
        chatRowHashMap.put(24, new InvestigateSuccessTxChatRow(24));//评价成功类型


        chatRowHashMap.put(25, new TabQuestionRxRow(25));//分组常见问题



        chatRowHashMap.put(100, new UnknownRxChatRow(100));//未知的类型消息
    }
