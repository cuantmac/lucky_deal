...
-keep public class com.luckydeal.view.GlideImageManager
-keep public class com.luckydeal.view.GlideImageSource
...
#---------------------------------bean---------------------------------
-keep class com.asiabill.testapp.model.**{*;}
-keep class com.asiabill.testapp.util.**{*;}
-keep class com.module.common.database.**{*;}
-keep class com.asiabill.testapp.viewmodel.**{*;}
-keep class com.asiabill.testapp.network.**{*;}
-keep class com.asiabill.testapp.procotol.**{*;}
-keep class com.asiabill.testapp.common.Constants {
     *;
}

-keep class com.asiabill.testapp.ndkc.NDKUtils {
     *;
}
