...
/**
 * Description：.
 * Author：Created by YJ_Song on 2019-06-05.
...
public class HorizontalProgressBar extends View {
    ...
    private HorizontalProgressBar.OnProgressChangedListener onProgressChangedListener;
    ...
    private void initAttrs(Context context, AttributeSet attrs) {
        ...
        bgColor = a.getColor(R.styleable.HorizontalProgressBar_zpb_bg_color, 0xff3F51B5);
        ...
        showText = a.getBoolean(R.styleable.HorizontalProgressBar_zpb_show_text, true);
    ...
    private void drawProgressText(Canvas canvas) {
        ...
        canvas.drawText(progress + "%", width / 2, baseLineY, progressTextPaint);
    }
    ...
    private void drawBackground(Canvas canvas) {
        ...
        RectF mRoundRecf = new RectF(0, 0, width, bgHeight);
        canvas.drawRoundRect(mRoundRecf, bgHeight / 2, bgHeight / 2, bgPaint);
    }
    ...
    public void setShowMode(HorizontalProgressBar.ShowMode showMode) {
        switch (showMode) {
            case ROUND:
                this.showMode = 0;
                break;
    ...
    public void setOnProgressChangedListener(HorizontalProgressBar.OnProgressChangedListener onProgressChangedListener) {
