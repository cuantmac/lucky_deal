...
public final class ResourceUtils {
    ...
    public static int getIdByName(String name) {
        return GlobalApp.get().getResources().getIdentifier(name, "id", GlobalApp.get().getPackageName());
    }
    ...
    public static int getStringIdByName(String name) {
        return GlobalApp.get().getResources().getIdentifier(name, "string", GlobalApp.get().getPackageName());
    }
    ...
    public static int getColorIdByName(String name) {
        return GlobalApp.get().getResources().getIdentifier(name, "color", GlobalApp.get().getPackageName());
    }
    ...
    public static int getDimenIdByName(String name) {
        return GlobalApp.get().getResources().getIdentifier(name, "dimen", GlobalApp.get().getPackageName());
    }
    ...
    public static int getDrawableIdByName(String name) {
        return GlobalApp.get().getResources().getIdentifier(name, "drawable", GlobalApp.get().getPackageName());
    }
    ...
    public static int getMipmapIdByName(String name) {
        return GlobalApp.get().getResources().getIdentifier(name, "mipmap", GlobalApp.get().getPackageName());
    }
    ...
    public static int getLayoutIdByName(String name) {
        return GlobalApp.get().getResources().getIdentifier(name, "layout", GlobalApp.get().getPackageName());
    }
    ...
    public static int getStyleIdByName(String name) {
        return GlobalApp.get().getResources().getIdentifier(name, "style", GlobalApp.get().getPackageName());
    }
    ...
    public static int getAnimIdByName(String name) {
        return GlobalApp.get().getResources().getIdentifier(name, "anim", GlobalApp.get().getPackageName());
    }
    ...
    public static int getMenuIdByName(String name) {
        return GlobalApp.get().getResources().getIdentifier(name, "menu", GlobalApp.get().getPackageName());
    }
    ...
    public static boolean copyFileFromAssets(final String assetsFilePath, final String destFilePath) {
        boolean res = true;
        try {
            String[] assets = GlobalApp.get().getAssets().list(assetsFilePath);
            if (assets.length > 0) {
                ...
                res = writeFileFromIS(
                        destFilePath,
                        GlobalApp.get().getAssets().open(assetsFilePath),
                        false
                );
            }
        } catch (IOException e) {
    ...
    public static String readAssets2String(final String assetsFilePath, final String charsetName) {
        InputStream is;
        try {
            is = GlobalApp.get().getAssets().open(assetsFilePath);
        } catch (IOException e) {
            e.printStackTrace();
            return null;
        }
    ...
    public static List<String> readAssets2List(final String assetsPath,
        ...
        try {
            return is2List(GlobalApp.get().getResources().getAssets().open(assetsPath), charsetName);
        } catch (IOException e) {
            e.printStackTrace();
            return null;
        }
    ...
    public static boolean copyFileFromRaw(@RawRes final int resId, final String destFilePath) {
        return writeFileFromIS(
                destFilePath,
                GlobalApp.get().getResources().openRawResource(resId),
                false
        );
    }
    ...
    public static String readRaw2String(@RawRes final int resId, final String charsetName) {
        InputStream is = GlobalApp.get().getResources().openRawResource(resId);
        byte[] bytes = is2Bytes(is);
        if (bytes == null) return null;
        if (isSpace(charsetName)) {
            return new String(bytes);
    ...
    public static List<String> readRaw2List(@RawRes final int resId,
                                            final String charsetName) {
        return is2List(GlobalApp.get().getResources().openRawResource(resId), charsetName);
    }
