...
public final class ScreenUtils {
    ...
    public static int getScreenWidth() {
        WindowManager wm = (WindowManager) GlobalApp.get().getSystemService(Context.WINDOW_SERVICE);
        if (wm == null) return -1;
    ...
    public static boolean isLandscape() {
        return GlobalApp.get().getResources().getConfiguration().orientation
    ...
    public static boolean isScreenLock() {
        KeyguardManager km =
                (KeyguardManager) GlobalApp.get().getSystemService(Context.KEYGUARD_SERVICE);
    ...
    public static void setSleepDuration(final int duration) {
        Settings.System.putInt(
                GlobalApp.get().getContentResolver(),
