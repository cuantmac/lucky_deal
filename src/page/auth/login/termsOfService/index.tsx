  ...
  return (
    <ScrollView contentContainerStyle={TextStyles.container}>
      <Text style={TextStyles.text}>
        &nbsp;&nbsp;This website is operated by Gesleben.me Throughout the site,
        the terms “we”, “us” and “our” refer to Gesleben.me. Gesleben.me offers
      ...
      <Text style={TextStyles.text}>
        ...
        residence, or that you are the age of majority in your state or province
      ...
      <Text style={TextStyles.text}>
        ...
        your reference only. We reserve the right to modify the contents of this
        site at any time, but we have no obligation to update any information on
      ...
      <Text style={TextStyles.text}>
        ...
        We cannot guarantee that your computer monitor's display of any color
        will be accurate.
      </Text>
      <Text style={TextStyles.text}>
      ...
      <Text style={TextStyles.text}>
        ...
        tools ”as is” and “as available” without any warranties, representations
      ...
      <Text style={TextStyles.text}>
        ...
        any third-party, including copyright, trademark, privacy, personality or
      ...
      <Text style={TextStyles.text}>
        &nbsp;&nbsp;In no case shall Gesleben.me, our directors, officers,
      ...
      <Text style={TextStyles.text}>
        &nbsp;&nbsp;You agree to indemnify, defend and hold harmless Gesleben.me
      ...
      <Text style={TextStyles.text}>
        ...
        we provide you Services shall be governed by and construed in accordance
      ...
      <Text style={TextStyles.text}>&nbsp;&nbsp;Geslebenservice@gmail.com</Text>
    </ScrollView>
  );
};
