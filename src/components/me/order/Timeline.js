...
const defaultCircleColor = '#767474';
const defaultLineWidth = 1;
const defaultLineColor = '#767474';
const defaultTimeTextColor = '#767474';
...
export default class Timeline extends PureComponent {
      ...
      case 'single-column-left':
        content = (
          <View style={[styles.rowContainer, this.props.rowContainerStyle]}>
            ...
            {item.detail.length !== 0 ? this.renderCircle(item, index) : null}
          </View>
        );
        break;
  ...
  _renderDetail(rowData, rowID) {
    const {isAllowFontScaling} = this.props;
    let description;
    if (typeof rowData.create_time === 'string') {
      description = (
        <Text
          style={[
            styles.description,
    ...
    } else if (typeof rowData.create_time === 'object') {
      description = rowData.create_time;
    }
...
const styles = StyleSheet.create({
  ...
  detail: {paddingTop: 0, paddingBottom: 30, marginTop: -4},
  description: {
    marginTop: 10,
  },
  separator: {
