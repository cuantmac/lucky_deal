        ...
        if ([message.isRobot isEqualToString:@"1"] && ![message.questionId isEqualToString:@""]) {
            ...
            if (message.isUseful) {
                ...
                if ([message.isUseful isEqualToString:@"none"]) {
                    ...
                    self.chatBackgroundView.frame = CGRectMake(67, CGRectGetMaxY(self.timeLabel.frame)+25, QMChatTextMaxWidth + 30, height+15 + 35);
            ...
            self.chatBackgroundView.frame = CGRectMake(67, CGRectGetMaxY(self.timeLabel.frame)+25, width+30, height+15);
        }
    }
}
...
- (void)imagePressGesture:(QMTapGestureRecognizer *)gestureRecognizer {
    ...
    if ([gestureRecognizer.picType isEqualToString:@"video"]) {
        ...
        [[LDTools currentViewController] presentViewController:_moviePlayerView animated:true completion:nil];
