...
- (void)setData:(CustomMessage *)message avater:(NSString *)avater {
    ...
    if ([message.fromType isEqualToString:@"1"]) {
        ...
        if (price.length > 0 || attrTwo.length > 0) {
            ...
            _titleLabel.frame = CGRectMake(100, 15, QM_kScreenWidth - 235, 20);
        }else {
            _titleLabel.numberOfLines = 2;
            _titleLabel.frame = CGRectMake(100, 15, QM_kScreenWidth - 235, strHeight > 35 ? 35 : strHeight);
        }
        ...
        if (isThreeLine && isTwoLine) {
            ...
            _descriptionLabel.frame = CGRectMake(100, CGRectGetMaxY(_titleLabel.frame) + 5, QM_kScreenWidth - 255, 15);
        }else if (isTwoLine && !isThreeLine) {
            _descriptionLabel.numberOfLines = 2;
            _descriptionLabel.frame = CGRectMake(100, CGRectGetMaxY(_titleLabel.frame) + 5, QM_kScreenWidth - 255, subStrHeight > 30 ? 30 : subStrHeight);
        }else if (!isTwoLine && isThreeLine) {
            _descriptionLabel.numberOfLines = 1;
            _descriptionLabel.frame = CGRectMake(100, CGRectGetMaxY(_titleLabel.frame) + 5, QM_kScreenWidth - 235, 15);
        }else {
            ...
            _descriptionLabel.numberOfLines = 2;
            _descriptionLabel.frame = CGRectMake(100, CGRectGetMaxY(_titleLabel.frame) + 5, QM_kScreenWidth - 235, subStrHeight > 30 ? 30 : subStrHeight);
        }
        ...
        if (itemType.length > 0) {
            ...
            CGFloat strHeight = [QMLabelText calculateTextHeight:dic[@"title"] fontName:QM_PingFangSC_Reg fontSize:14.0 maxWidth:QM_kScreenWidth - 235];
            _titleLabel.frame = CGRectMake(100, 10, QM_kScreenWidth - 235, strHeight > 35 ? 35 : strHeight);
            if (sub_Title.length > 0) {
                _descriptionLabel.text = sub_Title;
...
- (void)tapAction:(UITapGestureRecognizer *)gestureRecognizer {
    ...
    [[LDTools currentViewController] presentViewController:showWebVC animated:true completion:nil];
}
