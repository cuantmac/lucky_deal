...
- (void)createUI {
    ...
    flowView.frame = CGRectMake(67, CGRectGetMaxY(self.timeLabel.frame)+25, QMChatTextMaxWidth, 300);
    ...
    [_doneBtn setTitleColor:[UIColor colorWithHexString:isDarkStyle ? @"#ECECEC" : QMColor_News_Custom] forState:UIControlStateNormal];
    ...
    _sumLabel.textColor = [UIColor colorWithHexString:isDarkStyle ? @"#ECECEC" : QMColor_News_Custom];
...
- (void)setData:(CustomMessage *)message avater:(NSString *)avater {
    ...
    if ([message.fromType isEqualToString:@"0"]) {
        ...
        self.chatBackgroundView.frame = CGRectMake(67, CGRectGetMaxY(self.timeLabel.frame)+25, 260, messageHeight+selectHeight);

        flowView.frame = CGRectMake(67, CGRectGetMaxY(self.timeLabel.frame)+25, 260, messageHeight);
