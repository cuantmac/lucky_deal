...
- (CGSize)collectionView:(UICollectionView *)collectionView layout:(UICollectionViewLayout *)collectionViewLayout sizeForItemAtIndexPath:(NSIndexPath *)indexPath {
    CGFloat textWidth = [QMLabelText calculateTextWidth:self.dataArr[indexPath.row][@"button"] fontName:QM_PingFangSC_Reg fontSize:13 maxHeight:36];
...
- (void)showLabelText:(NSDictionary *)dic {
    self.dic = dic;
    CGFloat textWidth = [QMLabelText calculateTextWidth:dic[@"button"] fontName:QM_PingFangSC_Reg fontSize:13 maxHeight:36];
