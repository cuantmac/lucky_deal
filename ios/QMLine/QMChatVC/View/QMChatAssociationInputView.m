...
- (void)createView {
    ...
    _lineLabel.frame = CGRectMake(0, 0, QM_kScreenWidth, 1);
...
- (void)createUI {
    ...
    self.questionLabel.textColor = [UIColor colorWithHexString:QMColor_666666_text];
    [self.contentView addSubview:self.questionLabel];
}

- (void)setText:(NSString *)text withSelectText:(NSString *)selectText {
    
    NSAttributedString *attrStr = [QMLabelText colorAttributeString:text sourceSringColor:[UIColor colorWithHexString:QMColor_666666_text] sourceFont:[UIFont systemFontOfSize:15] keyWordArray:@[selectText] keyWordColor:[UIColor orangeColor] keyWordFont:[UIFont systemFontOfSize:15]];
