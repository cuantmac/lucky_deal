...
- (void)createUI {
    ...
    if ((QM_kScreenWidth - QM_kScreenHeight) > 0) {
        ...
        self.backView = [[UIScrollView alloc] initWithFrame:CGRectMake(30, 65, QM_kScreenWidth - 60, 376*kScale6)];
    }
    ...
    self.titleLabel.textColor = [UIColor colorWithHexString:isDarkStyle ? @"#D5D5D5" : QMColor_000000_text];
    ...
    for (int i = 0; i < self.evaluation.evaluats.count; i++) {
        ...
        [button setTitleColor:[UIColor colorWithHexString:isDarkStyle ? @"#D5D5D5" : QMColor_151515_text] forState:UIControlStateNormal];
    ...
    self.textView.backgroundColor = [UIColor colorWithHexString:isDarkStyle ? @"#3D3D3D" : @"#F8F8F8"];
    ...
    self.cancelButton.backgroundColor = [UIColor colorWithHexString:isDarkStyle ? @"#3D3D3D" : @"#E4E4E4"];
...
- (void)loadData:(NSArray *)reason {
    ...
    for (int i = 0; i < reason.count; i++) {
        ...
        [button setBackgroundColor:[UIColor colorWithHexString:isDarkStyle ? @"#3D3D3D" : @"#F8F8F8"]];
        [button setTitleColor: [UIColor colorWithHexString:isDarkStyle ? @"#D5D5D5" : QMColor_151515_text] forState:UIControlStateNormal];
        [button setTitleColor:[UIColor colorWithHexString:isDarkStyle ? @"#FFFFFF" : QMColor_News_Custom] forState:UIControlStateSelected];
