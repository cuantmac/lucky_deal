...
- (void)setDarkModeColor {
    self.nameLabel.textColor = [UIColor colorWithHexString:isDarkStyle ? @"#ECECEC" : QMColor_000000_text];
    self.stateInfoLabel.textColor = [UIColor colorWithHexString:isDarkStyle ? QMColor_999999_text : QMColor_666666_text];
    self.headerLabel.textColor = [UIColor colorWithHexString:isDarkStyle ? @"#ECECEC" : QMColor_000000_text];
}
